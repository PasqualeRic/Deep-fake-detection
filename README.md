...
|**1st epoch**                           |**100th**                                                 |
|----------------------------------------|----------------------------------------------------------|
|<img src='imgs/4.png' width="300px"/>   |<img src='imgs/final_generated_images.png' width="300px"/>|
...
This is an example with original, downsampling to 64x64 and upsampling to 256x256:
  |**Original image**                                                           |**64x64**                                                                    |**256x256**                                                                    |
  |-----------------------------------------------------------------------------|-----------------------------------------------------------------------------|-------------------------------------------------------------------------------|
  |<img src='imgs/original/real_image_real_image_248242.jpg.jpg' width="200px"/>|<img src='imgs/original/image_64x64real_image_248242.jpg.jpg' width="200px"/>|<img src='imgs/original/image_256x256real_image_248242.jpg.jpg' width="200px"/>|
...
**Gan**: This model uses images generated by a Gan without compression and upsampling, compared to real COCO images.

**Stable**: This model uses images generated by a Stable, compared to real COCO images.
